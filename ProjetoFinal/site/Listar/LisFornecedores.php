...
while ($linha = mysqli_fetch_array($listagem)) {
	...
	echo "<tr>
					...
					<td><a href='/fichas/ProjetoFinal/site/Remover/rem.php?id=".$linha['CodForn']."&tabela=".$tabela."'\><img src='/fichas/ProjetoFinal/site/img/delete.png' width='20' height='20'></a></td></tr>";
}
 ?>
</tr>
</tbody>
