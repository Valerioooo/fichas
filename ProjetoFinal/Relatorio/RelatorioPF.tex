...
Durante a primeira semana foram desenvolvidos programas simples pois estes destinavam-se a ajudar-nos a perceber como é que a linguagem PHP funciona.
Entre estes estão:
...
Durante a segunda semana houve a abordagem da linguagem SQL de maneira a ensinar os alunos a criar e manipular bases de dados relacionais.
...
Durante a terceira semana  sockets
