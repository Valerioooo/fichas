...
\begin{itemize}
  \item Se o Sistema Operativo utilizado for \textit{Windows} por meio da edição do ficheiro php.ini, descomentando a linha \textit{\say{extension=php\_sockets.dll}}  no mesmo.
...
O curso foi bastante interessante pois proporcionou-e uma aprendizagem autónoma com recurso à documentação específica das ferramentas, tutoriais em vídeo e a fóruns de programação na internet.
